...
def plot_instant_velocity(obj):
    ...
    try:
        ...
        if obj["name"] == 'hre_prob':
            ...
            ax.plot(obj["times"][:len(obj["u_bar_s"])], obj["u_bar_s"])
    

    ax.plot(obj["times"], obj["u_bar_t"]*np.ones(len(obj["times"])))
...
def plot_pdf_hrep(obj):
    ...
    x, pdf_u = obj["u_x_pdf"], np.array(obj["u_pdf"])*100
    mu = obj["u_bar_t"]
    sigma = obj["u_rms"]
